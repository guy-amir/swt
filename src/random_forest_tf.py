...
class WaveletsForestRegressor:
    def __init__(self, regressor='random_forest', criterion='mse', bagging=0.8, train_vi=False,
    ...
    def evaluate_smoothness(self, m=1000):
        ...
        predictions = np.zeros((np.shape(self.y)[0],1))
        ...
        print(f'Smoothness index: {alpha}')
